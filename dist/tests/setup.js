...
globals_1.jest.mock('ethers', () => ({
    ethers: {
        JsonRpcProvider: globals_1.jest.fn().mockImplementation(() => ({
            getNetwork: globals_1.jest.fn(() => Promise.resolve({ chainId: 11155111, name: 'sepolia' })),
            getBalance: globals_1.jest.fn(() => Promise.resolve('1000000000000000000')),
            getGasPrice: globals_1.jest.fn(() => Promise.resolve('20000000000')),
            estimateGas: globals_1.jest.fn(() => Promise.resolve('21000')),
            call: globals_1.jest.fn(() => Promise.resolve('0x')),
            getBlockNumber: globals_1.jest.fn(() => Promise.resolve(12345))
        })),
        Wallet: globals_1.jest.fn().mockImplementation(() => ({
            address: '0x1234567890123456789012345678901234567890',
            privateKey: '0x1234567890123456789012345678901234567890123456789012345678901234',
            connect: globals_1.jest.fn(),
            getBalance: globals_1.jest.fn(() => Promise.resolve('1000000000000000000')),
            estimateGas: globals_1.jest.fn(() => Promise.resolve('21000')),
            sendTransaction: globals_1.jest.fn(() => Promise.resolve({
                hash: '0xabcdef123456789',
                wait: globals_1.jest.fn(() => Promise.resolve({ status: 1 }))
            }))
        })),
        Contract: globals_1.jest.fn().mockImplementation(() => ({
            address: '0xa87e662061237a121Ca2E83E77dA8251bc4B3529',
            getFunction: globals_1.jest.fn().mockReturnValue(globals_1.jest.fn()),
            connect: globals_1.jest.fn().mockReturnThis(),
            interface: {
                encodeFunctionData: globals_1.jest.fn().mockReturnValue('0x1234'),
                decodeFunctionResult: globals_1.jest.fn().mockReturnValue(['result'])
            },
            vote: globals_1.jest.fn().mockImplementation(() => Promise.resolve({
                hash: '0x123456789abcdef',
                wait: globals_1.jest.fn().mockImplementation(() => Promise.resolve({ status: 1 }))
            })),
            getProposal: globals_1.jest.fn().mockImplementation(() => Promise.resolve({
                id: '1',
        ...
        formatEther: globals_1.jest.fn().mockImplementation((value) => value),
        parseEther: globals_1.jest.fn().mockImplementation((value) => value),
        isAddress: globals_1.jest.fn().mockReturnValue(true),
        getAddress: globals_1.jest.fn().mockImplementation((address) => address)
    }
}));
exports.testUtils = {
    createMockWallet: () => ({

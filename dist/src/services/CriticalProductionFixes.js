...
export class CriticalProductionFixes {
    ...
    MAX_PROCESSING_TIME = 60000; // 1 minute max
    MAX_PROPOSALS_PER_BATCH = 5; // Process only 5 at a time
    MINIMUM_DELAY_BETWEEN_OPERATIONS = 1000; // 1 second minimum
    RPC_TIMEOUT = 5000; // 5 second RPC timeout
    EMERGENCY_BRAKE_TIME = 45000; // Emergency stop at 45 seconds

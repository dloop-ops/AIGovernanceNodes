...
export class NodeRegistrationRecovery {
  ...
  private async checkNodeRegistrationStatus(nodeId: string, address: string): Promise<NodeRegistrationStatus> {
  ...
  private async recoverNodeRegistration(nodeId: string, status: NodeRegistrationStatus): Promise<{
    success: boolean;
  ...
  private async attemptRegistrationWithStaking(wallet: ethers.Wallet, nodeId: string): Promise<{
    success: boolean;
    transactionHash?: string;
    error?: string;
  }> {
  ...
  private async attemptSimpleRegistration(wallet: ethers.Wallet, nodeId: string): Promise<{
    success: boolean;
    transactionHash?: string;
    error?: string;
  }> {
  ...
  private async attemptRegistrationWithDirectApproval(wallet: ethers.Wallet, nodeId: string): Promise<{
    success: boolean;
    transactionHash?: string;
    error?: string;
  }> {

...
export const assetAddresses: Record<string, Record<string, string>> = {
  sepolia: {
...
export const getAssetAddresses = (networkName: string): Record<string, string> => {
...
export const getAssetAddress = (networkName: string, symbol: string): string => {
